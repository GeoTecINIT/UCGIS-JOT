...
export class PopupComponent implements OnInit {
  ...
  generatePDF() {
    ...
    if (this.selectedJobOffer.occuProf.title != null) {
      ...
      doc.link(15, currentLinePoint - 5, 600, currentLinePoint, { url: 'https://ucgis-tools-jot.web.app' });
  ...
  getOccupationProfiles(data: any) {
    const urlOCP = 'https://ucgis-tools-opt.web.app/#/detail/';
  ...
  headerRDF(data: any) {
    const urlBase = 'https://ucgis-tools-jot.web.app/#/detail/';
    const esco = 'http://data.europa.eu/esco/skill/';
    const occPro = 'https://ucgis-tools-opt.web.app/#/detail/';
    const knowledges = 'https://ucgis-tools-opt.web.app/#/detail/';
